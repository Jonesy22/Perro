	...
	return (
        <div style={{marginTop: "10px"}}>
			...
			<LineSeries
				...
				data={[{x: Date.now(), y: 0}, {x: Date.now(), y: 5000}]}
				color="#bf6b6b"
          	/>
